...
const instagram = document.getElementById('instagram')
 ...
 function preencherDados = (ObjetoJson1) => {
  photography.setAttribute('src', serie.foto)
  title.innerText = serie.nome
  year.innerHTML = serie.ano.join(' - ')
  director.innerHTML = serie.diretor.join(' - ')
  gender.innerHTML = serie.genero.join(' - ')
  elenco.innerHTML = serie.elenco.join(' - ')
  instagram.setAttribute('href', serie.instagram) 
}

preencherDados = (ObjetoJson2) => {
  console.log ()
  photography.setAttribute('src', serie.foto)
  title.innerText = serie.nome
  year.innerHTML = serie.ano.join(' - ')
